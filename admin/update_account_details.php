...
$organiser_refID = $_SESSION['organiser_refID'];

$data = fetchData("system_users", "WHERE user_id=$organiser_refID");
foreach ($data as $value) :
	$name = $value["full_name"];
	$email = $value["email"];
	$categoryID = $value["election_category_id"];

	$getCategoryName = fetchData("election_category", "WHERE id=$categoryID");
...
if (isset($_POST["submit"])) {
	...
	$sql = "UPDATE system_users SET full_name = '$fname', email = '$email', password = '$encPass', election_category_id = $category WHERE user_id = $organiser_refID";
			...
			<div class="col-md-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="title">Edit Organiser (<?php echo $name; ?>) Details</div>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" id="reference_id" name="reference_id" placeholder="<?php echo $organiser_refID; ?>" required disabled>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="password" class="form-control" id="password" name="pass" placeholder="12345678" required>
								</div>
							</div>
